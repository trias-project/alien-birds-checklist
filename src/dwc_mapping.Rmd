...
These categories of `degree_of_establishment` are conform the vocabulary of [Blackburn et al. 2011](http://doc.rero.ch/record/24725/files/bach_puf.pdf) for mapping the degree of establishment. For each level, we here add the prefix `Blackburn et al. 2011:` and the categories (A-E):
